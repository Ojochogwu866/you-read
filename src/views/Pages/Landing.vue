<template>
  <div class="w-full flex p-10 items-center">
    <div class="w-1/2">
      <div class="text-left text-6xl font-extrabold">
        Read Better <span class="text-boxColor">&</span><br />
        Cover more Books<br />
        Easily
      </div>
      ...
      <div class="">
        ...
        >
          ...
          <path
            ...
            fill="#e5e5e5"
          />
          <circle cx="105.5315" cy="315.00156" r="10.00001" fill="#A0006D" />
          <circle cx="100.57935" cy="401.00158" r="10" fill="#A0006D" />
          <path
          ...
          />
          <path
            d="M923.5,632.62241h-647a1,1,0,0,1,0-2h647a1,1,0,0,1,0,2Z"
            transform="translate(-275.5 -150.1205)"
            fill="#cbcbcb"
          />
          <polygon
